...
/*I2C initializations as Master*/
        ...
        I2C_MasterCreateEDMAHandle(I2C_BASEADDR, &g_m_dma_handle, i2c_master_callback, NULL, &edmaHandle);
...
status_t i2c_send_data(config_ascii_t *configuration,command_ascii_t *command)
{
	...
	if(configuration != NULL){
	    ...
	    result = I2C_MasterTransferBlocking(I2C_BASEADDR,&masterXfer);
